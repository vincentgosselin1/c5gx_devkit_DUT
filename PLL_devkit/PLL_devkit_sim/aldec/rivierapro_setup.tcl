...
# ACDS 17.1 590 win32 2020.05.06.22:39:06
# ----------------------------------------
...
# ----------------------------------------
# If PLL_devkit is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_devkit.vo"
}
